    ...
    <>
      ...
      {!currentUser ? (
        ...
        <div className="flex min-h-screen bg-slate-100/70 text-slate-800 antialiased">
          ...
          {/* Real-Time Hot Reload Notification Toast with direct tab navigation */}
          <NotificationToast onNavigate={setActiveTab} />
          ...
          <div className="flex-1 flex flex-col min-w-0">
            {/* Sticky Topbar with Live Currency Tickers & Notification Center */}
