...
export default function WhatsAppTemplateManager() {
  ...
  return (
    <div className="space-y-6 pb-8 font-sans max-w-7xl mx-auto animate-fade-in relative">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="pearl-card rounded-3xl p-5 bg-white border border-slate-200/90 shadow-sm space-y-3">
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3">
              ...
              {/* Sağ: Varsayılan Olarak Kaydet ve Şablonu Kaydet */}
              <div className="flex items-center gap-2.5">
                ...
                <button
                  type="button"
                  onClick={handleSave}
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-500 hover:to-teal-600 text-white font-black text-xs transition-all cursor-pointer shadow-md shadow-emerald-600/25 hover:scale-102 active:scale-98"
                >
